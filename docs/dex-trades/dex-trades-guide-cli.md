...
DEX Traders can perform pending orders and cancel orders through fastock-chain-cli, or through the UI provided by faStock-Chain ecosystem partners.
...
```bash
# example
fastock-chain-cli tx order new --product xxb-08a_okt --side BUY --price 1 --quantity 1 --from alice
# example return
{
...
```bash
# example
fastock-chain-cli query order detail ID0000000007-0000
# example return
{
 "txHash": "CF8CEC36B97F089DEA243655A70D1CB2AE906D712D71210BCDEBC47F184DB6C2",
 "orderId": "ID0000000007-0000",
 "sender": "fastock1cwvqt96wj222k2hue4pxcy5nxch6maaklknn7p",
 "product": "mycoin_okt",
 "side": "BUY",
 "price": "10.000000000000000000",
...
For more details on how to use faStock-Chain client, click [fastock-chain-cli](../resources/fastock-chain-cli.html).
