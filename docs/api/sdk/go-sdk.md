...
github: https://github.com/fastock/fastock-chain-go-sdk

---

### 1 utils function

All utils functions are defined in the package `utils` under path `fastock-chain-go-sdk/utils`. They can be invoked by the way like:

```go
import "github.com/fastock/fastock-chain-go-sdk/utils"
...
All auth functions are defined in the package `auth` under path `fastock-chain-go-sdk/module/auth`. They can be invoked by the way like:

```go
import "github.com/fastock/fastock-chain-go-sdk"
...
All token functions are defined in the package `token` under path `fastock-chain-go-sdk/module/token`. They can be invoked by the way like:
...
All staking functions are defined in the package `staking` under path `fastock-chain-go-sdk/module/staking`. They can be invoked by the way like:
...
All distribution functions are defined in the package `distribution` under path `fastock-chain-go-sdk/module/distribution`. They can be invoked by the way like:
...
All slashing functions are defined in the package `slashing` under path `fastock-chain-go-sdk/module/slashing`. They can be invoked by the way like:
...
All dex functions are defined in the package `dex` under path `fastock-chain-go-sdk/module/dex`. They can be invoked by the way like:
...
All order functions are defined in the package `order` under path `fastock-chain-go-sdk/module/order`. They can be invoked by the way like:
...
All order functions are defined in the package `backend` under path `fastock-chain-go-sdk/module/backend`. They can be invoked by the way like:
...
All ammswap functions are defined in the package `ammswap` under path `fastock-chain-go-sdk/module/ammswap`. They can be invoked by the way like:
...
All farm functions are defined in the package `farm` under path `fastock-chain-go-sdk/module/farm`. They can be invoked by the way like:
...
All governance functions are defined in the package `governance` under path `fastock-chain-go-sdk/module/governance`. They can be invoked by the way like:
...
```json
{
  ...
  "recipient": "fastock-chain1ntvyep3suq5z7789g7d5dejwzameu08m6gh7yl",
  "amount": [
    {
      "denom": "okt",
      "amount": "10.24"
...
All tendermint functions are defined in the package `tendermint` under path `fastock-chain-go-sdk/module/tendermint`. They can be invoked by the way like:
